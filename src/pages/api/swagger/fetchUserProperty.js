...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`https://deep-index.moralis.io/api/v2/0x9E5763c1D0Cc261b0c804Af1f284C9540322BB7a/events?chain=mumbai&topic=0xca74bbd802be843092c6d6fb12f347f06c6f589dd46dde9786fcade7fc5c9bbc`, {
      method: 'POST',
      headers: {
