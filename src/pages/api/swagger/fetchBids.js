...
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`https://deep-index.moralis.io/api/v2/0x9E5763c1D0Cc261b0c804Af1f284C9540322BB7a/events?chain=mumbai&topic=0x64284ef655c7c03a2337ae03e8356c3509fe2cb719b625da963184f7ed8658ee`, {
      method: 'POST',
      headers: {
