...
const Footer = () => {
  return (
    <footer className="bg-slate-100  text-white  mt-10 w-full h-60 flex rounded-t-md border-t-2">
      ...
      <span className="text-orange-500">NexTradeX</span>
   </p>
   </div>
   ...
   <p className='text-red-100 text-lg ' > © PWM Group 2023</p>
    <p className='text-red-100 text-lg ' > © PWM Group 2023</p>
    <p className=' text-zinc-950 text-lg ' > Integer. MAX_VALUE by Rahul, Aayush , Mayank , Rohit</p>
    <p className='text-red-100 text-lg ' ></p>
